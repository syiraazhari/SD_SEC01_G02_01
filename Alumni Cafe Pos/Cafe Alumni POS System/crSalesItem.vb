...
Public Class crSalesItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cafe_Alumni_POS_System.crSalesItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSalesItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSalesItem = New crSalesItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
