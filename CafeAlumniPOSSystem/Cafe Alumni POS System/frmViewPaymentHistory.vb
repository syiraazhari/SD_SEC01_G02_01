...
Public Class frmViewPaymentHistory
    Sub LoadPaymentHistory()
        ...
        Try
            ...
            While Read.Read
                i += 1
                Me.Guna2DataGridView1.Rows.Add(i, Read.Item("SalesID").ToString, Read.Item("InvoiceNo").ToString, Read.Item("SDate").ToString, Read.Item("STime").ToString, Read.Item("Description").ToString, Read.Item("Amount").ToString)
            End While
            Read.Close()
            cn.Close()
