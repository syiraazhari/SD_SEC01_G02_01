...
Public Class frmStockInHand
    ...
    Private Sub Guna2DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Guna2DataGridView1.CellContentClick
        ...
        If ColStr = "ColEdit" Then
            ...
            With frmUpdateStock
                cn.Open()
                cmd = New MySqlCommand("select PID,Description,sum(PurQty-SalesQty) as StockAvailable from tbl_stock where PID like '" & Me.Guna2DataGridView1.Rows(e.RowIndex).Cells(1).Value & "'", cn)
                Read = cmd.ExecuteReader
                Read.Read()
