...
Public Class frmUserProfile
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        cmd = New MySqlCommand("insert into tbl_users(Username,Password,Name,Email,Role,Status,Image) values(@Username,@Password,@Name,@Email,@Role,@Status,@Image)", cn)
        With cmd
    ...
    Private Sub Guna2DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Guna2DataGridView1.CellContentClick
        ...
        Try
            ...
            ElseIf colstr = "ColDel" Then
                If MsgBox("Do you want to delete the userID?", vbYesNo + vbQuestion) = vbYes Then
                    cn.Open()
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        ...
        Try
            cn.Open()
            cmd = New MySqlCommand("Select * From tbl_users where Username like '%" & txtSearch.Text & "%' or Name like '%" & txtSearch.Text & "%'", cn)
            Read = cmd.ExecuteReader
            While Read.Read
                i += 1
                Me.Guna2DataGridView1.Rows.Add(i, Read.Item("UserID").ToString, Read.Item("Username").ToString, Read.Item("Password").ToString, Read.Item("Name").ToString, Read.Item("Email").ToString, Read.Item("Role").ToString, Read.Item("Status").ToString)
