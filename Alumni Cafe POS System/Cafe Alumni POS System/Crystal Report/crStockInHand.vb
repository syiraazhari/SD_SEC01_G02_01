...
Public Class crStockInHand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cafe_Alumni_POS_System.crStockInHand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrStockInHand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crStockInHand = New crStockInHand()
        rpt.Site = Me.Site
        Return rpt
    End Function
