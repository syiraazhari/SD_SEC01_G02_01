...
Public Class crSalesPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cafe_Alumni_POS_System.crSalesPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSalesPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSalesPrint = New crSalesPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
