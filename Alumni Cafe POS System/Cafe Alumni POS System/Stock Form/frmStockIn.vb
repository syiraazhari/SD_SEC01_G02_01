...
Public Class frmStockIn
    Private Sub btnShow_Click(sender As Object, e As EventArgs) Handles btnShow.Click
        ...
        Try
            ...
            cn.Open()
            cmd = New MySqlCommand("select StockID, SDate,PID, Description, Category, sum(Qty) as Qty from tbl_stockin where SDate between '" & Date1 & "' and '" & Date2 & "' group by SDate, PID, Qty order by SDate desc", cn)
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        ...
        For Each dr As DataGridViewRow In Me.Guna2DataGridView1.Rows
            DT.Rows.Add(dr.Cells(1).Value, dr.Cells(2).Value, dr.Cells(4).Value, dr.Cells(5).Value, dr.Cells(6).Value)
        Next
